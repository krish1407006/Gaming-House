...
router.get("/games/homepage-list", adminController.getAdminHomepage);
router.put("/games/reorder-homepage", adminController.reorderHomepage);
router.put("/games/homepage/:id", adminController.toggleGameHomepage);
